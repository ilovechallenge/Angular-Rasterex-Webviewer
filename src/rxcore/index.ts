...
export class RXCore {
    ...
    public static deleteMarkupByID(id: number): void {
        RxCore.deletemarkupbyID(id);
    }

    public static setMarkupfromJSON(markupJSON, DocRef = null) {
        return RxCore.setMarkupfromJSON(markupJSON, DocRef);
    }

    public static setUniqueMarkupfromJSON(markupJSON, DocRef = null) {
        return RxCore.setUniqueMarkupfromJSON(markupJSON, DocRef);
    }
